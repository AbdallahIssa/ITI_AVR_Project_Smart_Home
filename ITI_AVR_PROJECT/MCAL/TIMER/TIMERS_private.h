...
#define ICR1                            *((volatile u16*)(0x46))//Top value can be changed throught this register in FastPWM mode
...
// I put it here because it doesn't belong to specific timer
